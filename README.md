...
```bash
python examples/basic_recall.py        # 最简上下文召回
python examples/compression_demo.py   # 压缩策略演示
python examples/tool_governance.py    # 工具治理演示
python examples/sub_agent_delegation.py  # 子代理委托
python examples/business_agent.py     # 完整 CRM 客服 Agent 集成
```

...
[uv](https://github.com/astral-sh/uv) 会自动创建并管理 `.venv` 虚拟环境：
...
# 启动开发服务
make venv-run
# 或激活后：uvicorn context_agent.api.http_handler:app --reload --host 0.0.0.0 --port 8080
```
